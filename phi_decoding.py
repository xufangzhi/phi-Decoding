...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/cpfs01/user/xufangzhi/o1/data/aime2024_test.json')
    ...
    parser.add_argument('--threshold', type=float, default=0.79) # threshold for early stopping
